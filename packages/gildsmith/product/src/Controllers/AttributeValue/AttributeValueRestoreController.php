...
use Gildsmith\Product\Requests\AttributeValue\AttributeValueRestoreRequest;
...
{
    public function __invoke(AttributeValueRestoreRequest $request, string $attribute, string $value): bool
    {
