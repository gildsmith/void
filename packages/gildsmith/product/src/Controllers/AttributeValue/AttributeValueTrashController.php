...
use Gildsmith\Product\Requests\AttributeValue\AttributeValueTrashRequest;
...
{
    public function __invoke(AttributeValueTrashRequest $request, string $attribute, string $value): bool
    {
        ...
        return AttributeValue::delete($value);
    }
}
