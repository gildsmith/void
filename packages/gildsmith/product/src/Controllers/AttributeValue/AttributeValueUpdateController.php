...
use Gildsmith\Product\Requests\AttributeValue\AttributeValueUpdateRequest;
...
{
    public function __invoke(AttributeValueUpdateRequest $request, string $attribute, string $value): ?AttributeValueInterface
    {
