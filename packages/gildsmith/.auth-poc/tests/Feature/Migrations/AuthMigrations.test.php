...
it('creates auth and actor tables', function () {
...
it('replaces an existing users table with the gildsmith users table', function () {
    ...
    $migration = require __DIR__.'/../../../database/migrations/0001_01_01_000000_create_users_table.php';
    $migration->up();
...
it('requires unique customer and employee users', function () {
